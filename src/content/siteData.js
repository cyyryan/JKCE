...
export const projects = [
  {
    ...
    gallery: [
      { src: '/images/projects/tlowitsis/01.webp', alt: 'Tlowitsis Nation site', caption: 'Site overview.' },
      { src: '/images/projects/tlowitsis/02.webp', alt: 'Tlowitsis Nation construction', caption: 'Construction progress.' },
      { src: '/images/projects/tlowitsis/03.webp', alt: 'Tlowitsis Nation build', caption: 'ICF construction on site.' },
      { src: '/images/projects/tlowitsis/04.webp', alt: 'Tlowitsis Nation progress', caption: 'Site progress.' },
      { src: '/images/projects/tlowitsis/05.webp', alt: 'Tlowitsis Nation aerial', caption: 'Aerial site view.' },
      { src: '/images/projects/tlowitsis/06.webp', alt: 'Tlowitsis Nation framing', caption: 'Structural framing.' },
      { src: '/images/projects/tlowitsis/07.webp', alt: 'Tlowitsis Nation interior', caption: 'Interior construction.' },
      { src: '/images/projects/tlowitsis/08.webp', alt: 'Tlowitsis Nation site', caption: 'Site coordination.' },
    ],
    featuredOnHome: true,
    cta: {
